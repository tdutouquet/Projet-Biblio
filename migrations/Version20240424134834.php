 ...
 */
final class Version20240424134834 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE comment (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, livre_id INT NOT NULL, content LONGTEXT NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', rating DOUBLE PRECISION NOT NULL, INDEX IDX_9474526CA76ED395 (user_id), INDEX IDX_9474526C37D925CB (livre_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE rental (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, room_id INT NOT NULL, start_date DATE NOT NULL, end_date DATE NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_1619C27DA76ED395 (user_id), INDEX IDX_1619C27D54177093 (room_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE salles (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, capacite NUMERIC(10, 0) NOT NULL, emplacement INT NOT NULL, disponibilite TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE salles_equipements (salles_id INT NOT NULL, equipements_id INT NOT NULL, INDEX IDX_3C34F596B11E4946 (salles_id), INDEX IDX_3C34F596852CCFF5 (equipements_id), PRIMARY KEY(salles_id, equipements_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE rental ADD CONSTRAINT FK_1619C27D54177093 FOREIGN KEY (room_id) REFERENCES salles (id)');
        $this->addSql('ALTER TABLE salles_equipements ADD CONSTRAINT FK_3C34F596B11E4946 FOREIGN KEY (salles_id) REFERENCES salles (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE salles_equipements ADD CONSTRAINT FK_3C34F596852CCFF5 FOREIGN KEY (equipements_id) REFERENCES equipements (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE rental DROP FOREIGN KEY FK_1619C27D54177093');
        $this->addSql('ALTER TABLE salles_equipements DROP FOREIGN KEY FK_3C34F596B11E4946');
        $this->addSql('ALTER TABLE salles_equipements DROP FOREIGN KEY FK_3C34F596852CCFF5');
        ...
        $this->addSql('DROP TABLE salles_equipements');
